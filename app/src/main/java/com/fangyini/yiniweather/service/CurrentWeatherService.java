...
import static com.fangyini.yiniweather.MainActivity.mCitySearch;
import static com.fangyini.yiniweather.MainActivity.mWeather;
...
public class CurrentWeatherService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        try {
            URL url = Utils.getWeatherForecastUrl(Constants.WEATHER_ENDPOINT, latitude, longitude);
